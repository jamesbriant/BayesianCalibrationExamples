...
import mici
import numpy as np
from models.sin_abc import Model, get_ModelParameterPriorDict
from freethreading import process_workers
from argparser import parse_args
from dataloader import thin_runs_by_div, save_chains_to_netcdf
...
def main():
    ...
    DATACOMP = thin_runs_by_div(DATACOMP, div)

    n_sim = DATACOMP.shape[0]
    ...
    tc = jnp.reshape(DATACOMP[:, 2:], (-1, 3)).astype(jnp.float64)
