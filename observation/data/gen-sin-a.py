...
from true_funcs import TrueParams, eta

# OPTION - MUST PICK ONE
# mode = "linear"
mode = "random"

if mode not in ["linear", "random"]:
    raise Exception('variable `mode` must be a string. Either "linear" or "random".')
...
n_obs = 1000  # number of observation points
