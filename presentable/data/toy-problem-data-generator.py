...
np.savetxt(f"data/toy/field{''.join(filename_extensions)}.csv", data, delimiter=',')




####### simulation #######
n = 50 # number of simulation output points
...
np.savetxt(f"data/toy/sim{''.join(filename_extensions)}.csv", data, delimiter=',')