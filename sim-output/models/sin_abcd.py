    ...
    def k_eta(self, params_constrained) -> gpx.kernels.AbstractKernel:
        ...
        return gpx.kernels.ProductKernel(
            kernels=[
                ...
                gpx.kernels.RBF(
                    active_dims=[4],
                    lengthscale=jnp.array(params["lengthscales"]["theta_3"]),
                ),
            ]
        )
...
def get_ModelParameterPriorDict(
    ...
    print(f"A1: {A1}, B1: {B1}")
    A2 = (0.8 - tmm2[0]) / (tmm2[1] - tmm2[0])
    B2 = (1.2 - tmm2[0]) / (tmm2[1] - tmm2[0])
    print(f"A2: {A2}, B2: {B2}")
    A3 = (0.6 - tmm3[0]) / (tmm3[1] - tmm3[0])
    B3 = (1.1 - tmm3[0]) / (tmm3[1] - tmm3[0])
    print(f"A3: {A3}, B3: {B3}")
    ...
    prior_dict: ModelParameterPriorDict = {
        "thetas": {
            ...
            "theta_3": ParameterPrior(
                dist.Uniform(low=A3, high=B3),
                name="theta_3",
            ),
        },
        "eta": {
